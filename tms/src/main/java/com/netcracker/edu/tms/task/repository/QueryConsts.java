...
public class QueryConsts {
    ...
    public static final String SELECT_USERS_PROJECTS = new String(
            "SELECT p from ProjectTeam u, Project p where u.projectId=p.id and u.userId=:userId");
    ...
    public static final String SELECT_TEAM_FOR_PROJECT_ID = new String(
            "SELECT u from ProjectTeam utp, UserWithPassword u where u.id=utp.userId and utp.projectId=:projectId");
}