...
public interface TaskDao {
    ...
    List<Task> getTaskByReporter(BigInteger reporterId);//argument should be UserWithPassword instance

    List<Task> getTaskByAssignee(BigInteger assigneeId);//argument should be UserWithPassword instance
